...
export const Footer = () => {
  return (
    <footer className="py-8 bg-background-dark border-t border-white/10">
      <div className="container mx-auto px-6 text-center text-gray-400">
        
        {/* Social Media Icons */}
        <div className="flex justify-center flex-wrap gap-6 mb-4">
          {/* GitHub */}
          <a href="https://github.com/sinaaanck" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Github">
          ...
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/sinaaanck/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="LinkedIn">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/sinaaan.ck" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
             <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Snapchat */}
          <a href="https://www.snapchat.com/@sinaaanck" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Snapchat">
             <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* X (Twitter) */}
          <a href="https://x.com/sinaaan_ck?" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="X (Twitter)">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
